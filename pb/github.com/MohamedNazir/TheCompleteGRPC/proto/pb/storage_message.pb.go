...
func (Storage_Driver) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{0, 0} }
...
func (*Storage) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func init() { proto.RegisterFile("storage_message.proto", fileDescriptor7) }
