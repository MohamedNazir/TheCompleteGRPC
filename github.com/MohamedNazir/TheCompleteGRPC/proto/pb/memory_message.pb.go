...
func (Memory_Unit) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{0, 0} }
...
func (*Memory) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func init() { proto.RegisterFile("memory_message.proto", fileDescriptor3) }
