...
func (*CPU) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*GPU) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func init() { proto.RegisterFile("processor_message.proto", fileDescriptor4) }
